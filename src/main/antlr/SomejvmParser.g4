// EXAMPLE PARSER
parser grammar SomejvmParser;

options { tokenVocab=SomejvmLexer; }
somejvmFile : lines=line* EOF ;
...
/*
parser grammar JvmLangParser;

options { tokenVocab=JvmLangLexer; }

line          : EOL* statement (EOL+ | EOF);
statement     :
*/
